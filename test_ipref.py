...
class TestIpref(TestCase):
    ...
    def test_makeCommandServer(self):
        ip = Ipref('192.168.22.129')
        command =  ['ssh', '-n', '192.168.22.129', 'iperf3', '-s', '-D', '-1']
    ...
    def test_makeCommandClient(self):
        ...
        ip.test = 'udp'
        ip.time = '11'
        command = ['iperf3', '-c','192.168.22.129', '-t','11', '-u']
    ...
    def test_parse(self):
        ...
        ip.time = '2'
        ip.result = ['Connecting to host 192.168.22.129, port 5201\n[  4] local 192.168.22.129 port 56078 connected to 192.168.22.129 port 5201\n[ ID] Interval           Transfer     Bandwidth       Retr  Cwnd\n[  4]   0.00-1.00   sec   441 MBytes  3.69 Gbits/sec  667    390 KBytes   \n[  4]   1.00-2.00   sec   346 MBytes  2.90 Gbits/sec  544    192 KBytes       \n']
